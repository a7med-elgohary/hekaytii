    ...
    <div className="new-hero-container">
      ...
      <header className="new-navbar">
        ...
        <div className="new-nav-actions">
          ...
          <button className="btn-dark-purple" onClick={() => navigate('/create-story')}>ابدأ المغامرة الآن</button>
        </div>
      </header>
      ...
      <main className="new-hero-split">
        ...
        <div className="hero-text-side">
          ...
          <div className="hero-buttons-side hide-on-mobile">
            ...
            <button className="btn-dark-purple lg" onClick={() => navigate('/create-story')}>ابدأ المغامرة الآن</button>
          </div>
        </div>
